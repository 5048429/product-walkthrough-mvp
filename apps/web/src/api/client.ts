...
function normalizeRunParams(value: unknown): RunParams {
  ...
  return {
    ...
    plan_source: asNullableString(raw.plan_source),
    target_url: asNullableString(raw.target_url),
    target_name: asNullableString(raw.target_name),
    target_credentials_ref: asNullableString(raw.target_credentials_ref),
